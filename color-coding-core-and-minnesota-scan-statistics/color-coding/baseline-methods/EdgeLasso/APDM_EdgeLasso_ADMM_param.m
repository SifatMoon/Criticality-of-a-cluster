function [computingTime,bjscore] = APDM_EdgeLasso_ADMM_param(filename,lda)
startTime=tic;
...
parameter_1 = 0.15;
[p_value,A,x,B,I,label]=getDataAPDM_param(filename,parameter_1);
x_hat = x;
p = 1;
alphaMax = 0.15;
s = size(B);
...
bjscore = bjscore / max(sqrt(length(S_star)), 1)
